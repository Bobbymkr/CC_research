...
* **Why it matters tomorrow:** As agent runtimes increasingly write, compile,
  install dependencies, and execute code in terminal environments, static rules
  will often be too rigid. RAASA should be framed as an adaptive containment
  layer that can react to measured behavioral drift, not as an instant or
  complete AI-agent safety solution.
