...
## Corpus Check
- 115 files · ~1,104,302 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 798 nodes · 1925 edges · 29 communities detected
- Extraction: 59% EXTRACTED · 41% INFERRED · 0% AMBIGUOUS · INFERRED: 785 edges (avg confidence: 0.64)
...
- `UnixSocketServer` --uses--> `Run a tc command. Returns True on success, False on any failure.`  [INFERRED]
  RM_practical\code\core\ipc.py → raasa\k8s\enforcer_sidecar.py
- `UnixSocketServer` --uses--> `Handle incoming IPC command.`  [INFERRED]
  RM_practical\code\core\ipc.py → raasa\k8s\enforcer_sidecar.py
...
Cohesion: 0.05
Nodes (51): Factory function: selects and initialises the Observer + Enforcer pair     that, ActionEnforcer, _default_runner(), enforcement.py note L18, Enum, LLMPolicyAdvisor, llm_advisor.py note L1, llm_advisor.py note L132 (+43 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (44): _apply_mode_override(), _build_backend(), build_parser(), _containment_profile_for_tier(), app.py note L16, app.py note L182, Factory function: selects and initialises the Observer + Enforcer pair     that, run_controller() (+36 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (21): mean(), compute_means.py note L1, _clamp(), FeatureExtractor, features.py note L13, _clamp(), risk_model.py note L16, RiskAssessor (+13 more)
...
Cohesion: 0.11
Nodes (25): _allow_default_interface_fallback(), _apply_memory_limit(), _apply_network_throttle(), _clear_network_throttle(), _find_host_pids_for_pod_uid(), handle_command(), _init_k8s_client(), _is_valid_k8s_name() (+17 more)
...
Cohesion: 0.21
Nodes (4): WorkloadSpec, build_scenario(), ScenarioItem, ScenarioTests
...
- **Thin community `Community 24`** (4 nodes): `Invoke-SSH()`, `New-RestrictedKeyCopy()`, `collect_aws_live_validation.ps1`, `collect_aws_live_validation.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (4 nodes): `Invoke-SSH()`, `New-RestrictedKeyCopy()`, `Save-RemoteOutput()`, `deep_diagnose_aws.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (4 nodes): `Invoke-SSH()`, `New-RestrictedKeyCopy()`, `collect_phase1g_calibration_snapshot.ps1`, `collect_phase1g_calibration_snapshot.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `ContainerTelemetry` connect `Community 0` to `Community 1`, `Community 3`, `Community 7`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **Why does `run_controller()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 6`, `Community 8`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `Tier` connect `Community 1` to `Community 3`, `Community 2`, `Community 11`, `Community 6`?**
